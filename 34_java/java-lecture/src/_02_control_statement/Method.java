...
public class Method {
    public static void main(String[] args) {
        ...
        System.out.println(multi_10_2(numbers2)); //[I@28a418fc

        // 실행 후 결과 확인
        System.out.println("원래 numbers 확인: "+ Arrays.toString(numbers2));
    ...
    public static int sum(int x, int y){
        // 함수의 리턴 타입과 실제 리턴해주는 타입이 일치해야 합니다.
        return x + y;
    }
    ...
    *  - 실제 "값"이 함수로 전달하는 것, 원래의 값은 변경되지 않음
    *
    * call by address
