...
//        super(); // Person 생성자 실행!(부모 생성자의 매개변수가 없을 때는 생략 가능)
//        this.campus = campus;
//        this.age = age;
//        this.name = name;
...
//        super(name, age); // (매개변수 있는 경우) 생략 불가능!
//        this.campus = campus;
//        System.out.println("Student 클래스의 생성자가 실행됐습니다.");
//    }
...
//        this.name = name;
//        this.age = age; //부모 필드가 private 이기 때문에 접근 불가능

//        super(); // 생략 가능
        // setter 를 이용해서 초기화 시켜주기
        super(name, age);
        // super 내부에 setAge 와 setName 이 있기 때문에 Student 생성자에서는 초기화되지 않아도 됨
//        setAge(age);
//        setName(name);
    }
